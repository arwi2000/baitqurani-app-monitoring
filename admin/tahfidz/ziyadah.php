...
<body>
    ...
    <div class="main">
        ...
        <div class="header">
            ...
            <!-- Subtitle header -->
            <h3 class="header-subtitle">DATA ZIADAH</h3>
            ...
            <div class="header-main">
                <div class="container-fluid">
                    ...
                    <!-- Tabel data ziadah dengan DataTables -->
                    <table id="data-ziadah" class="table table-bordered table-striped table-hover">
                        <thead>
                            <tr>
                                <th>Tanggal</th>
                                <th>NIS</th>
                ...
                <div class="modal-dialog  modal-lg">
                    <div class="modal-content">
                        ...
                        <div class="modal-header">
                            ...
                            <h1 class="modal-title fs-4 ms-2" id="staticBackdropLabel">Form Data Ziadah</h1>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>

                        <!-- Body modal (isi form atau konten) -->
                        <form method="POST" action="crud-ziadah.php">
    ...
    <script src="/admin/assets/js/dashboard-admin.js"></script>

    <!-- Inisialisasi DataTable pada tabel #data-ziadah -->
    <script>
        $(document).ready(function () {
            $('#data-ziadah').DataTable();
        });
    </script>
</body>
